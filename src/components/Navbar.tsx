...
import { Search, Bell, HelpCircle, Globe, Menu as MenuIcon, Shield, Calendar } from 'lucide-react';
...
import UpcomingMeetingsPopup from './meetings/UpcomingMeetingsPopup';
...
export default function Navbar({ onMenuClick }: NavbarProps) {
  ...
  const { meetings, loading: meetingsLoading } = useUpcomingMeetings();
