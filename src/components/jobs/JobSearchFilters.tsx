...
export default function JobSearchFilters({ onFiltersChange, initialFilters }: JobSearchFiltersProps) {
  ...
  const handleFilterChange = React.useCallback((type: keyof FilterState, value: string) => {
